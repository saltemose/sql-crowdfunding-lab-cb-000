...
"SELECT projects.title, SUM(pledges.amount)-projects.funding_goal AS amount_over_goal FROM projects INNER JOIN pledges.project_id = projects.id GROUP BY project.title HAVING amount_over_goal >= 0;"
end
